...
pub static GENRE_MAPPINGS: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    HashMap::from([
        ...
        ("HIPHOP BATTLE 2000s", "Hip-Hop"),
        ("HIPHOP BATTLE 2010s", "Hip-Hop"),
        ("HIPHOP BATTLE 90s", "Hip-Hop 90s"),
        ("HIPHOP BATTLE BEATS", "Hip-Hop"),
        ("HIPHOP BATTLE BREAKS", "Hip-Hop"),
        ("HIPHOP BATTLE CLUB", "Hip-Hop"),
        ("HIPHOP BATTLE G-FUNK INSTRUMENTAL", "Hip-Hop"),
        ("HIPHOP BATTLE G-FUNK", "Hip-Hop"),
        ...
        ("HIPHOP BATTLE SPECIAL", "Hip-Hop Trap"),
        ("HIPHOP BATTLE TRAP", "Hip-Hop Trap"),
        ("HIPHOP BATTLE TWERK", "Hip-Hop Trap"),
        ...
        ("HIPHOP JAM RNB", "Hip-Hop"),
        ("HIPHOP JAM", "Hip-Hop"),
        ("HIPHOP JERSEY CLUB", "Jersey Club"),
        ("HIPHOP MIAMI BASS", "Hip-Hop"),
        ...
        ("HOUSE EURODANCE NEW", "House Eurodance"),
        ("HOUSE EURODANCE", "House Eurodance"),
